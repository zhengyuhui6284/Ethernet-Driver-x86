...
#define E1000_PCI_CMD_MASK	0x0005	/* P86/P91 - cr[0] hardwired to 0? */
...
{
	// TO DO: implement this function to read from a register 
...
{
	//TO DO: implement this function to write from a register 
    outl(iobase + E1000_IO_IOADDR, reg);
...
#define E1000_TXCW		0x00178	/* transmit config word reg	*/
#define E1000_RXCW		0x00180	/* receive config word reg	*/
...
#define E1000_CTRL_ASDE_EN	0x00000020	/* enable autospeed detect*/
...
#define E1000_PBA_DEFAULT	0x00100030	/* PBA reg default value */
